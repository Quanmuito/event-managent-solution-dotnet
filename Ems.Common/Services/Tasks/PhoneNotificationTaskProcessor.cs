...
) : ITaskProcessor<PhoneNotificationTaskMessage<TData>>
{
    ...
    {
        logger.LogInformation("Processing phone notification for Operation: {Operation}", message.Operation);
        ...
        logger.LogInformation("Phone notification processed successfully");
    }
